...
- `../colette-exercise-api/docs/ENGINEERING_GUIDE.md` — how we structure backend code, persist data, and run
  background / async work.
- `../colette-exercise-api/docs/GRAPHQL.md` — how we expose the API.
